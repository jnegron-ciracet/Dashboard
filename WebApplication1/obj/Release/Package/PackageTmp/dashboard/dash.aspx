...
<body>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" OnLoad="UpdatePanel2_Load">
                  <ContentTemplate>
                    ...
                    <div id="resize-chrt1" class="chart-container">                        
                        ...
                        <h3><dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Monthly PM's By Hospital (">
                            <ClientSideEvents Click="function(s, e) {	
	                                                    popHospital.Show();}" />
                            </dx:ASPxLabel>
                            <dx:ASPxLabel ID="lblSelectedHospital" runat="server" Text=""></dx:ASPxLabel> )
                        </h3>                      
                        <p>Overall <span><asp:Label ID="lblPMCompliance" CssClass="overall" runat="server" Text=""></asp:Label>%</span></p>
                        </header>                        
                        ...
                        <div id="chrt1_detail" class="chart-body" runat="server">
                          ...
                          <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="Data Source=CIRACETSRV002\CIRACETSRV002;Initial Catalog=CiracetNew;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="spS_Dashboard_Yearly_PM_History_PerHospital" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                    ...
                    <div id="resize-chrt2" class="chart-container">                  
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="Data Source=CIRACETSRV002\CIRACETSRV002;Initial Catalog=CiracetNew;Integrated Security=True" SelectCommand="spS_Dashboard_Monthly_PM_History" SelectCommandType="StoredProcedure" ProviderName="System.Data.SqlClient">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="hospital" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div id="resize-chrt3" class="chart-container">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="Data Source=CIRACETSRV002\CIRACETSRV002;Initial Catalog=CiracetNew;Integrated Security=True" SelectCommand="spS_Dashboard_Monthly_PM_History" SelectCommandType="StoredProcedure" ProviderName="System.Data.SqlClient">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="0" Name="hospital" Type="Int32" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <!-- POPUP: POPHOSPITAL --> 
                    <dx:ASPxPopupControl ID="popHospital" runat="server" ClientInstanceName="popHospital" HeaderText="Select Hospital!" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AutoUpdatePosition="True" Width="400px">
                      <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl1"  runat="server">
                            <table>
                                <tr>
                                    <td style="padding-right: 5px;"> <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Hospital:" Font-Names="Calibri" Font-Size="Medium" Font-Bold="True"></dx:ASPxLabel> </td>
                                    <td>
                                      <dx:ASPxComboBox ID="cmbHospital" runat="server" ValueType="System.String" ClientInstanceName="cmbHospital" AutoPostBack="True" OnSelectedIndexChanged="cmbHospital_SelectedIndexChanged" Native="True">
	...
	closePopUp();
                                    ...
                                    <td> <dx:ASPxButton ID="btnClosePopHospital" runat="server" Text="Close" Height="35px" Width="80px" Font-Size="0.91em" Theme="Default" ClientInstanceName="btnClosePopHospital" AutoPostBack="False">
                ...
                <!-- DIV: CHART 4 -->                
                <div id="resize-chrt4" class="chart-container">
                    <header class="chart-header">
                    <div class="chart-img">
                        <dx:ASPxBinaryImage ID="ASPxBinaryImage1" runat="server" Height="40px" Width="40px">
                        <EmptyImage Url="~/Images/Dashboard Imgs/User.jpg"></EmptyImage>                             
                        </dx:ASPxBinaryImage>
                    </div>
                    <h3> <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h3>
                    <p>BMET Compliance <span><asp:Label ID="lblUserOverall" CssClass="overall" runat="server" Text=""></asp:Label>%</span></p>
                    </header>
                    <div class="chart-body">
                    <!-- DIV: two-chrts 1 -->
        ...
        <asp:HiddenField ID="hidden_rsz2" runat="server" Value="0" />
